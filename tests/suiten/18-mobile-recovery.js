...
exports.lauf = async ({ p }) => {
  ...
  p.enthaelt('Service Worker nutzt einen neuen Cache', sw, "const VERSION = 'ft-v104'");
  ...
  p.enthaelt('Notfallseite zeigt denselben Versionsstand', recovery, 'Fitness Tracker V100');
};
