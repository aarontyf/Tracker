...
2. **`VAULT_EMAIL` von Aarons Adresse trennen** — aktuell würden die Trainingsdaten eines Freundes an `jeetunaaron750@gmail.com` adressiert. Das muss in die Einstellungen, sonst ist es ein Datenschutzproblem.
